...
//     <div class="cards">
//       <div class="card">
//         <div class="tag purple">Most Popular</div>
//         <h3>Career Coaching</h3>
//         <p>Get personalized guidance from industry experts to accelerate your career growth</p>

//         <div class="details">
//           <p><strong>DURATION:</strong> 3–6 months</p>
//           <p><strong>INVESTMENT:</strong> From $99/session</p>
//         </div>
...
//       <div class="card">
//         <div class="tag pink">High Demand</div>
//         <h3>Startup Internships</h3>
//         <p>Gain real world experience with innovative startups and build your professional network</p>

//         <div class="details">
//           <p><strong>DURATION:</strong> 2–6 months</p>
//           <p><strong>INVESTMENT:</strong> Paid positions</p>
//         </div>
...
//         <button class="btn">View Opportunities</button>
//       </div>

//       <div class="card">
//         <div class="tag blue">Exclusive</div>
//         <h3>MVP Labs</h3>
//         <p>Turn your innovative ideas into funded startups with our comprehensive incubator program</p>

//         <div class="details">
//           <p><strong>DURATION:</strong> 6–12 months</p>
//           <p><strong>INVESTMENT:</strong> Equity-based</p>
//         </div>
